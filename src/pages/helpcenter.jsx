      ...
      <motion.div
        ...
        <Paper
          ...
          sx={{
            ...
            mb: { xs: 3, sm: 4 },
            borderRadius: 3,
            bgcolor: (theme) => theme.palette.mode === 'dark' ? 'background.card' : 'background.subtle',
            color: (theme) => theme.palette.mode === 'dark' ? 'text.primary' : 'text.primary',
            border: (theme) => `1px solid ${theme.palette.primary.main}`,
            boxShadow: (theme) => `0 4px 12px ${theme.palette.mode === 'dark' ? 'rgba(255, 168, 77, 0.2)' : 'rgba(255, 138, 0, 0.15)'}`,
          }}>
          <Typography 
            variant='h5' 
            gutterBottom
